...
import { CircularProgress, Typography, Grid, Card, CardContent, Chip } from "@mui/material";
...
const StatusListItem = styled.li`
    margin-bottom: 5px; /* Espacement vertical entre les éléments li */
`;
